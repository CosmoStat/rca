...
class io_fits: public virtual io_image {
      void read_type(char *File_Name);   
          void read_size (char *);
          void read_ima (char *);
          void write_ima (char *);
	   ...
	   long NBytes;
          ...
          io_fits();
          ~io_fits();
          void read_ima_int (char *File_Name, Iint & Image);
          void read_ima_float (char *File_Name, Ifloat & Image);
          void read_ima_complex_f (char *File_Name, Icomplex_f & Image);
	  void write_ima_int (char *File_Name, Iint & Image);
   	  void write_ima_float (char *File_Step_Name, const Ifloat & Image);
	  void write_ima_complex_f (char *File_Step_Name, Icomplex_f & Image);
              };
